...
from welpurse_v2.utils import login_required, is_logged_in
...
from welpurse_v2.utils import login_required, get_current_user
...
@app_routes.route(
    "/events_view/<welfare_id>/<event_id>/", methods=["GET", "POST"]
)
@login_required
...
def create_event():
    ...
    return render_template(
        "create_event.html", current_user=current_user, form=form
    )
